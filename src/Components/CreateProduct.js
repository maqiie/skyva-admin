...
const ProductForm = () => {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const response = await axios.get("https://skyva-api-1.onrender.com/categories");
  ...
  const createProduct = async (productData) => {
    try {
      ...
      const response = await axios.post(
        "https://skyva-api-1.onrender.com/products/create_product",
        productData,
        {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append(
        "product[on_offer]",
        formData.on_offer === "true" || formData.on_offer === true
      );
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mb-4">
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full border-b-2 border-gray-300 focus:outline-none focus:border-blue-500 py-2 px-3 rounded-md appearance-none"
            >
